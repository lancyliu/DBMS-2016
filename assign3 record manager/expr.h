...
typedef enum ExprType {
  EXPR_OP,       // operator invocations
  EXPR_CONST,   //constants (stored as a Value struct)
  EXPR_ATTRREF  //references to attribute values (represented as the position of an attribute in the schema)
} ExprType;  
